...
const projects = [
  {
    ...
    title: 'ForgeTube',
    category: 'GenAI',
    description: 'Real-time video generation platform with AI-powered content synthesis',
    tags: ['PyTorch', 'Diffusion Models', 'WebGPU'],
  ...
  },
  {
    ...
    title: 'Neural Router',
    category: 'ML',
    description: 'Optimization system for dynamic route planning using reinforcement learning',
    tags: ['TensorFlow', 'RL', 'Graph Neural Networks'],
  ...
  },
  {
    ...
    category: 'Infra',
    description: 'Scalable infrastructure for deploying autonomous AI agents in production',
    tags: ['Kubernetes', 'LangChain', 'FastAPI'],
